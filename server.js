...
app.post('get_training_person', async (req, res) => {
    try {
...
app.post('/training_camp', async (req, res) => {
    try {
...
app.post('/analysis_report', async (req, res) => {
    ...
    try {
        const report = await db.get_analysis_report(req.body.person_name, form_name, req.body.start_date, end_date);
...
app.post('/training_camp_analysis_report', async (req, res) => {
    ...
    try {
        const report = await db.get_training_camp_analysis_report(
